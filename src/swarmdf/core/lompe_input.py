...
class LompeInput:
    ...
    def __init__(self, sat_id, start_time, end_time, datasets):
    ...
    def _plot_dataset(self, dataset, ds, data_object, t0, t1, hem, show_global_data, polar_ax, cs_ax, legend_stuff, quiverscales):
        ...
        added = legend_stuff['added']
        quiver_info = legend_stuff['quiver_info']
        legend_handles = legend_stuff['legend_handles']
        ...
        if (dataset == 'superdarn'): 
            ...
            if show_global_data:
                ...
                polar_ax.scatter(sub.glat, sub.glon/15, color=c, s=8, marker='^')
            ...
            quiver_info[dataset] = (c, quiverscales['convection'], 'm/s')
        ...
        # SuperMAG
            ...
            if show_global_data:
                ...
                polar_ax.scatter(sub.lat, sub.lon/15, color=c, s=8, marker='^')
            ...
            quiver_info[dataset] = (c, quiverscales['ground_mag']*1e9, 'nT')
        ...
        # Iridium/AMPERE
            ...
            if show_global_data:
                ...
                sub = sub[sub.lat >0] if hem=='north' else sub[sub.lat <0]
                polar_ax.scatter(sub.lat, sub.lon/15, color =c, s=8, marker='o')
            ...
            quiver_info[dataset] = (c, quiverscales['space_mag_fac']*1e9, 'nT')
        ...
        # Swarm magnetic field
            ...
            if show_global_data:
                ...
                polar_ax.scatter(sub.Latitude, sub.Longitude/15, color =c, s=8, marker='o')
        ...
        # Swarm electric field #TODO fix when I have data
            ...
            quiver_info[dataset] = (c, quiverscales['efield'], 'V/m')
        ...
        # DMSP/SSIES 17 & 18
            ...
            if show_global_data:
                ...
                polar_ax.scatter(sub.gdlat, sub.glon/15, color=c, s=8, marker='o')
    ...
    def plot_lompe_input(self, grids, time_bounds, data_objects_per_grid, gif_speed = 550, show_global_data=True, show_plot=False):
        """
        ...
        show_plot : bool, optional
            If True, display each figure interactively during generation.
        ...
        legend_stuff = {"legend_handles": [], # matplotlib legend entries
                        ...
                        "quiver_info": {}, # quiver scale info per dataset
                        }
        ...
        for grid, ct, t0, t1, data_objects in zip(grids, time_bounds['ct'], time_bounds['t0'], time_bounds['t1'], data_objects_per_grid):
            ...
            y = 0.8
            for key, (color, scale, unit) in legend_stuff['quiver_info'].items():
                arrowax.text(3, y, f"{scale:.0f} {unit}", color=color, fontsize=15, va='top')
                y -= 0.25
