...
def build_right_sidebar(gui):
        ...
        # Adjust figure size
        gui.label_figh = customtkinter.CTkLabel(gui.frame_figsize, text="Fig height:", font=FONT_NORMAL)
        ...
        # gui.label_figw = customtkinter.CTkLabel(gui.frame_figsize, text="Fig width:", font=FONT_NORMAL)
        ...
        gui.checkbox_magcoords = customtkinter.CTkCheckBox(gui.tab_plot, text='Polar plot in magnetic coords', font=FONT_NORMAL) #, command=gui.replot_lompe_input
        ...
        gui.checkbox_showdata = customtkinter.CTkCheckBox(gui.tab_plot, text='Show global data coverage', font=FONT_NORMAL)
        ...
        gui.button_replotinput = customtkinter.CTkButton(gui.tab_plot, command=gui.update_lompe_input, text='Apply', font=FONT_BIGGERB)
        ...
        gui.label_gifspeed = customtkinter.CTkLabel(gui.tab_gif, text="Animation speed (ms/frame):", font=FONT_NORMAL)
        ...
        # Apply new speed
        gui.button_apply = customtkinter.CTkButton(gui.tab_gif, text="Apply", font=FONT_BIGGERB, command=gui.apply_gif_parameters)
        ...
        # L2 parameter
        gui.label_l2 = customtkinter.CTkLabel(gui.frame_regul, text="l2:", font=FONT_NORMAL)
